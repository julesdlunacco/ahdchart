...
function App() {
  ...
  const [savedCharts, setSavedCharts] = useState<Array<{id: number; name: string; date: string; input: typeof input; report: string}>>([]);
  ...
  return (
    <div className="ahd-container" style={{ maxWidth: '1200px', margin: '0 auto', padding: '20px', fontFamily: theme?.fontFamily }}>
      <h1 style={{ textAlign: 'center', marginBottom: '1.5rem' }}>Human Design Chart</h1>
      
      {showForm ? (
          <>
            <div style={{ display: 'flex', justifyContent: 'flex-end', alignItems: 'center', maxWidth: '600px', margin: '0 auto 0.75rem' }}>
            ...
            >
                ...
                />
                {cityLoading && <div style={{ fontSize: '0.85rem' }}>Searching…</div>}
                {cityResults.length > 0 && (
                    <ul style={{ listStyle: 'none', padding: 0, margin: '0.5rem 0', maxHeight: '150px', overflowY: 'auto', border: '1px solid #ddd', borderRadius: 4 }}>
                    {cityResults.map((c, idx) => (
                        <li
                        key={`${c.city}-${c.country}-${idx}`}
                        onClick={() => handleCitySelect(c)}
                        style={{ padding: '0.4rem 0.6rem', cursor: 'pointer', borderBottom: '1px solid #eee' }}
                        >
                ...
                <ul style={{ listStyle: 'none', padding: 0, margin: 0, maxHeight: '150px', overflowY: 'auto', border: '1px solid #ddd', borderRadius: 4 }}>
                    ...
                    <li
                        ...
                        style={{ padding: '0.4rem 0.6rem', cursor: 'pointer', borderBottom: '1px solid #eee', background: input.timezone === tz ? '#e5e7eb' : 'white' }}
                    >
                        {tz}
                    </li>
                    ))}
                      ...
                      {chartData && (
                          <>
                              <div style={{ 
                                  ...
                                  <div style={{ fontSize: '0.75rem', color: '#6b7280', textTransform: 'uppercase', letterSpacing: '0.5px', marginBottom: '4px' }}>Type</div>
                                  <div style={{ fontSize: '1.125rem', fontWeight: '600', color: theme?.textColor || '#1f2937' }}>{chartData.type}</div>
                              </div>
                              <div style={{ 
                                  padding: '1rem', 
                                  background: '#f9fafb', 
                                  ...
                                  <div style={{ fontSize: '0.75rem', color: '#6b7280', textTransform: 'uppercase', letterSpacing: '0.5px', marginBottom: '4px' }}>Authority</div>
                                  <div style={{ fontSize: '1.125rem', fontWeight: '600', color: theme?.textColor || '#1f2937' }}>{chartData.authority}</div>
                              </div>
                              <div style={{ 
                                  padding: '1rem', 
                                  background: '#f9fafb', 
                                  ...
                                  <div style={{ fontSize: '0.75rem', color: '#6b7280', textTransform: 'uppercase', letterSpacing: '0.5px', marginBottom: '4px' }}>Profile</div>
                                  <div style={{ fontSize: '1.125rem', fontWeight: '600', color: theme?.textColor || '#1f2937' }}>{chartData.profile}</div>
                              </div>
                              <div style={{ 
                                  padding: '1rem', 
                                  background: '#f9fafb', 
                                  ...
                                  <div style={{ fontSize: '0.75rem', color: '#6b7280', textTransform: 'uppercase', letterSpacing: '0.5px', marginBottom: '4px' }}>Definition</div>
                                  <div style={{ fontSize: '1.125rem', fontWeight: '600', color: theme?.textColor || '#1f2937' }}>{chartData.definition}</div>
                              </div>
                          </>
                      )}
                  </div>
